...
void copyMat(int order, float source[order][order],
             float target[order][order]) {
...
int main() {
  float yetAnotherMat[3][3] = {{3, 0, 2}, {2, 0, -2}, {0, 1, 1}};

  float mat[3][3] = {{6, 1, 1}, {4, -2, 5}, {2, 8, 7}};

  float largeMat[4][4] = {
      {1, 0, 2, -1}, {0, 1, 0, -1}, {0, 0, -6, 8}, {0, 0, 0, 5}};
