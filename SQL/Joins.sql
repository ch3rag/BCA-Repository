...
SELECT SALESMAN.SALESMAN_ID, SALESMAN.SALESMAN_NAME, SALESMAN.CITY, CUSTOMER.CUST_NAME FROM
SALESMAN LEFT JOIN CUSTOMER ON SALESMAN.SALESMAN_ID = CUSTOMER.CUSTOMER_ID
